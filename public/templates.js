...
export function SyncTemplates(data, opt) {
    let pdf;
...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Contrato de Prestação de Serviço Educacional</title>
        <style>
            * {
                padding: 0;
                margin: 0;
    ...
    <body>
        <div id="content">
            <div>
                <h2>
                    QUADRO RESUMO DO CONTRATO DE PRESTAÇÃO DE SERVIÇO
                    EDUCACIONAL
                </h2>
                ...
                <p>
                    Pelo presente instrumento particular, que fazem entre si de
                    um lado a parte denominadas como
                    <strong>
                        “CONTRATANTE/ALUNO ou CONTRATANTE/RESPONSÁVEL LEGAL” </strong
                    >, abaixo qualificado:
                </p>
                ...
                <p>
                    ...
                    inscrita no CNPJ: 18.953.641/0001-26, com sede no endereço:
                    Rua Japurá, 341, Santa Cruz, Betim/MG, CEP: 32.667.358,
                    responsável pela(s) unidade(s) abreviadas por “PTB” e
                    “Golfinho Azul”
                </p>
                <p>
                    <strong>
                    ...
                    responsável pela(s) unidade(s) abreviadas por “Centro”,
                    “Aliança Eterna/IBAE” e “YES”
                </p>
                ...
                <p>
                    Dessa forma, já qualificados, aceitam e os seguintes termos
                    e condições abaixo:
                </p>
                ...
                <p>
                    A carga horária contratada tem o total de ${data}}                    horas-aulas. Sendo o curso ministrado em 1 módulo, que terá
            ...
            <div class="sign" id="sign">
                <span class="sign-marker" id="sign-marker">
                    CONTRATANTE/ RESPONSÁVEL LEGAL
                </span>
                <span class="sign-marker" id="sign-marker"> CONTRATADA </span>
            </div>

            <table>
                <tr>
                    <td class="field-sign">Testemunha 1:</td>
                    <td class="field-sign">Testemunha 2:</td>
                </tr>
                <tr>
                    <td class="field-sign">Nome:</td>
                    <td class="field-sign">Nome:</td>
                </tr>
                <tr>
                    <td class="field-sign">CPF:</td>
                    <td class="field-sign">CPF:</td>
                </tr>
                <tr>
                    <td class="field-sign">Assinatura:</td>
                    <td class="field-sign">Assinatura:</td>
                </tr>
            </table>
...
`
    const particulares = `<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8" />
        <title>Contrato de Prestação de Serviço Educacional</title>
    ...
    <body>
        <div id="content">
            <div>
                ...
                <p>
                    A carga horária contratada tem o total de ${data.cargaHoraria} horas-aulas. O curso é ministrado em 1
                    módulo que que terá a duração estipulada dentro do
                    calendário didático para o cumprimento da carga horária. De
                    acordo com o planejamento didático, as aulas têm previsão
                    para início no dia ${data.paDATA}, sujeito à alteração
    ...
    <body>
        <div id="content">
            <div>
                ...
                <p>
                    A carga horária contratada tem o total de ${data.cargaHoraria} horas-aulas. O curso Standard One -
                    Standard é ministrado em 1 módulo que será realizado dentro
                    do calendário didático estipulado para o cumprimento da
                    carga horária. De acordo com o planejamento didático, as
                    aulas têm previsão para início no dia ${data.paDATA},
                    sujeito à alteração mediante aviso prévio.
                </p>
                <strong> SOBRE VALOR E DESCONTOS </strong>
                <p>
                    O valor total da carga horária contratada é de
    ...
    <body>
        <div id="content">
            <div>
                ...
                <p>
                    A carga horária contratada tem o total de ${data.cargaHoraria} horas-aulas. Sendo o curso ministrado em
